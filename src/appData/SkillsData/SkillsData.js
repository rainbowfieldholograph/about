...
export const skillsData = [
  ...
  },
  {
    ...
    description:
      'Могу ввести в консоли: npm init vite@latest и выбрать нужные мне параметры. Есть небольной опыт работы с ним. Он мне нравится своей простотой и скоростью.',
  },
  {
    title: 'NodeJS',
  ...
  },
  {
    ...
    description:
      'Сделал по документации и гайдам (+немного stackoverflow) пару серверных приложений на GraphQL. Умею работать с playground. Синтаксис не помню наизусть, опыта еще не так много, но с документацией способен на что угодно (wtf). +ApolloServer (самую малость, уже и забыл, что такое вообще существовало)',
  },
  {
    title: 'Apollo Client',
    iconComponent: (
